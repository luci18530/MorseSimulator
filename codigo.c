...
int DURSLEEP_ENTRECHAR = 2 * DUR; // TEMPO DE DELAY ENTRE CADA CARACTERE, DEVIDO AO DELAY DO INTRACHAR APLICADO ANTES DESSA FUNÇÃO (1 DIT) ENTÃO O VALOR É 2 AO INVES DE 3
int DURSLEEP_ENTREPALAVRA = 5 * DUR; // TEMPO DE DELAY ENTRE CADA PALAVRA, DEVIDO AO DELAY DO ENTRECHAR APLICADO ANTES DESSA FUNÇÃO (2 DIT) ENTÃO O VALOR É 5 AO INVES DE 7
